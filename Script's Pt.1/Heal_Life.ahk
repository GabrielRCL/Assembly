...
;2) AUTO HEALING LIFE: 
;[ESTAGIO 1]
Porcentagem_Para_Healar_Vida1 := 95		;Se sua [VIDA] estiver abaixo desse valor o BOT irá Apertar a [Hotkey_de_Cura1] e [Hotkey_de_HealthPotion1]
Hotkey_de_Cura1 = {F2}						;Hotkey da SPELL de CURA no TIBIA!!! irá ser pressionada assim que a vida estiver abaixo do [Valor_Para_Healar_Vida1] 
...
;[ESTAGIO 3]
Porcentagem_Para_Healar_Vida3 := 60		;Se sua [VIDA] estiver abaixo desse valor o BOT irá Apertar a [Hotkey_de_Cura1] e [Hotkey_de_HealthPotion1]
Hotkey_de_Cura3 = {F1}					;Hotkey da SPELL de CURA no TIBIA!!! irá ser pressionada assim que a vida estiver abaixo do [Valor_Para_Healar_Vida1] 
